...
describe('TokenPolicy', () => {
  ...
  describe('GET /admin/chan/:namespace/token-policies', () => {
    describe('auth', () => {
      it('200', async () => {
        process.env.CHAN_ADMIN_PASSWORD = 'password'
  ...
  describe('PUT /admin/chan/:namespace/token-policies/write-token-required', () => {
    describe('auth', () => {
      it('204', async () => {
        process.env.CHAN_ADMIN_PASSWORD = 'password'
        const namespace = 'namespace'
  ...
  describe('PUT /admin/chan/:namespace/token-policies/read-token-required', () => {
    describe('auth', () => {
      it('204', async () => {
        process.env.CHAN_ADMIN_PASSWORD = 'password'
        const namespace = 'namespace'
  ...
  describe('DELETE /admin/chan/:namespace/token-policies/write-token-required', () => {
    describe('auth', () => {
      it('204', async () => {
        process.env.CHAN_ADMIN_PASSWORD = 'password'
        const namespace = 'namespace'
  ...
  describe('DELETE /admin/chan/:namespace/token-policies/read-token-required', () => {
    describe('auth', () => {
      it('204', async () => {
        process.env.CHAN_ADMIN_PASSWORD = 'password'
        const namespace = 'namespace'
